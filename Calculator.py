...
root.geometry("360x380+500+200")
val = ""
data = StringVar()
display = Entry(root, textvariable = data, bd = 29, justify = "right", bg = "cyan", font = ("ariel", 20))
...
btnc = Button(root, text = "c", font = ("Ariel", 12, "bold"), bd = 12, height = 2, width = 6, command = lambda:btnClear())
...
btn_eql = Button(root, text = "=", font = ("Ariel", 12, "bold"), bd = 12, height = 2, width = 6, command = lambda:btnEql())
